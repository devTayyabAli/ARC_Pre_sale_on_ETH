  ...
  const getaccount = async () => {
    ...
    if (acc == "No Wallet") {
      ...
      let gettokenValue = await BUSDContractOf.methods
        ...
        let tokenpercentag = (arcSold / 2333000000) * 100;
      ...
      USDTvalue = parseFloat(USDTvalue).toFixed(4);
      ...
      ETHValue = parseFloat(ETHValue).toFixed(4);
        ...
        <div className="container ">
          ...
          <div className="col-md-7 left_connent text-start">
              ...
              <p className="home_land_para1  text-white">
                Buy ARC with BUSD and USDC on Binance Chain.  WL Partners, please proceed with your choice of tokens to
            ...
            >
              <div className="right_content_card">
                <h4 className="card_heading_span pt-3">Presale Started</h4>
                <div className="text_days fs-5 ">
                  <Countdown
                    date={
                      Date.now() + (parseInt("1678143600") * 1000 - Date.now())
                    }
                    renderer={renderer}
                  />
                </div>
                <div className="progress_bar_nav mt-3">
                  ...
                  <div className="box_text text-white">
                    <span>
                      Public Exchange launch goes live on Wednesday March 15th 2023
                    </span>
                  </div>
