...
import ico_landing from './ico landing.pdf'
      ...
      <div className="container">
        <div className=" left_connent text-start">
          ...
          <p className="home_land_para text-white">
            Buy ARC with USDC and USDT on Ethereum Chain or BUSD and USDC on
            Binance Chain. WL Partners, please proceed with your choice of
            tokens to buy (Eth or BSC) you have 2 Hours from the Pre-Sale
            opening before general buyers. After your transaction completed,
            please make sure you refer to the pdf to add the Archie Chain
            network to show your coin in your wallet.
          </p>
        </div>
        ...
        <div className="">
          <a href={ico_landing} download >
            <div class="btn btn-1 w-50">
              <svg>
                <rect x="0" y="0" fill="none" width="100%" height="100%" />
              </svg>
              How to configure the archie chain?
            </div>
          </a>
        </div>
